...
import Cash from "./versions/cash";
import Trivia from "./versions/trivia";
      ...
      >
        <div
          className="
            ...
            p-6 hover:ring-2 hover:ring-purple-400 transition
          "
        >
          <p className="text-lg font-semibold mb-3">Tricky Trivia</p>
          <Trivia/>
        </div>
