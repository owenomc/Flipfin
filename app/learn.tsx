          ...
          <View key={lesson.id} style={styles.lessonContainer}>
            ...
            <TouchableOpacity
              style={[
                ...
                idx % 2 === 0 ? styles.leftLesson : styles.rightLesson, // alternate left/right for tree effect
              ]}
...
const styles = StyleSheet.create({
  container: {
    ...
    ...(Platform.OS === "web"
      ? { minHeight: 600 } // Use a numeric value instead of "100vh" for ViewStyle compatibility
      : { minHeight: 600 }),
  },
  header: {
    fontSize: 22,
